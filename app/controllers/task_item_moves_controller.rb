...
class TaskItemMovesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      ...
      format.json { render "task_items/show", status: :ok, location: task_list_task_item_url(target_list, @task_item) }
    end
  end
